...
echo "have to add the following snippet at the end of the file:"
echo ""
...
echo ""
echo "Don' forget you also have to reload your terminal window before you will"
echo "notice any changes."
echo ""
